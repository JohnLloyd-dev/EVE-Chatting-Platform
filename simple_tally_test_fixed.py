#!/usr/bin/env python3
"""
Simple test script to debug Tally extraction logic - FIXED VERSION
"""
...
def test_extraction_logic():
    ...
    sample_data = {
        "questions_and_answers": [
            {
                "question": "In this fantasy are you a man or a woman?",
                "answer": "man"
            },
            {
    ...
    print("🧪 Testing Tally Extraction Logic - FIXED VERSION")
    print("=" * 60)
    
    # Test the extraction logic step by step - using EXACT same logic as backend
    user_gender = ""
    ai_gender = ""
    ai_age = ""
    ai_ethnicity = ""
