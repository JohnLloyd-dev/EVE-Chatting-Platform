...
# This script deploys the entire application to VPS and restores the database
...
echo "🚀 EVE Chat Platform - VPS Deployment"
echo "====================================="
...
# Restore data from final123.sql
print_status "Restoring data from final123.sql..."
docker exec temp-postgres pg_restore -U postgres -d chatting_platform --data-only /tmp/final123.sql
...
echo "   ✅ Database restored from final123.sql"
