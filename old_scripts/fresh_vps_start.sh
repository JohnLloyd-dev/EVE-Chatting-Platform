...
# Fresh VPS Start Script
# Completely terminates all connections and creates fresh database

echo "🚀 Fresh VPS Start"
echo "=================="
...
echo "Step 7: Creating ALL 8 tables..."
...
echo "Step 11: Verifying database setup..."
docker exec eve-chatting-platform_postgres_1 psql -U postgres -d chatting_platform -c "
